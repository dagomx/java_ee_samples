package com.dagobravo.rest.ws.client;
...
/**
 * This is a simple test class for invoking REST web service using JAX-RS client
 * APIs
 */
	...
	public static void testAddCourseForm() {
		...
		if (response.getStatus() != 200) {
			...
			System.out.println("Error invoking REST Web Service - " + 
					response.getStatusInfo().getReasonPhrase() + ", Error Code : " + response.getStatus());
