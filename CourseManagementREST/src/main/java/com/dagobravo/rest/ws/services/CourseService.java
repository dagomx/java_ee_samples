package com.dagobravo.rest.ws.services;
...
import com.dagobravo.rest.ws.dto.Course;
import com.dagobravo.rest.ws.dto.Teacher;
...
public class CourseService {
	...
	@Path("add")
	public Response addCourseFromForm(@FormParam("name") String courseName, @FormParam("credits") int credits)
